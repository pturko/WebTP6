...
public class AddPublicationConfirmCommand implements ICommand{
    ...
    public static final Logger LOG=Logger.getLogger(AddPublicationConfirmCommand.class.getName());  
...
//          LOG.info(image);
          ...
          if (verify==true) {
                ...
                publ.addPublication(name, price, description, image);
          }
        ...
        if (session.getAttribute("login") != null) {
            ...
            if (verify==true) {
                ...
                page = ConfigurationManager.getInstance().getProperty(ConfigurationManager.ADD_PUBLICATION_CONFIRM_PAGE_PATH);
            } 
            else {
                ...
                page = ConfigurationManager.getInstance().getProperty(ConfigurationManager.ADD_PUBLICATION_ERROR_PATH);
            }
