...
import ua.bionic.turko.commands.*;
...
public class LanguageRuAdminCommand implements ICommand{

    public static final Logger LOG=Logger.getLogger(LanguageRuCommand.class.getName());  
    private static final String PARAM_NAME_LANG = "lang_ru";
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
          ...
          if (session.getAttribute("login") != null) {
              ...
              page = ConfigurationManager.getInstance().getProperty(ConfigurationManager.LANGUAGE_ADMIN_PAGE_PATH);
          }else{
